...
module bd_f60c
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 200000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk;
  input [31:0]probe0;
  input [15:0]probe1;
  input [0:0]probe2;
  input [12:0]probe3;
  ...
  bd_f60c_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe33(net_slot_0_axi_wstrb),
        .probe34(net_slot_0_axi_aw_ctrl),
        .probe35(net_slot_0_axi_w_ctrl),
        .probe36(net_slot_0_axi_b_ctrl),
        .probe37(net_slot_0_axi_ar_ctrl),
        .probe38(net_slot_0_axi_r_ctrl),
        .probe4(probe4_1),
